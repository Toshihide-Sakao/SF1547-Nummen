...
for j = 1:numofpoints
    ...
    while hnorm > tol && i < maxiter
        ...
        % vekofnorms = [vekofnorms vpa(hnorm)];
        % vpa(hnorm)
...
% a). Koordinaterna blir:
% p0: (0, 0)
% p1: (205, 1000)
% p2: (458, 2480)
% p3: (712, 1750)
% p4: (1020, 0)
% Det är möjligt att se att den konvergerar kvadratiskt för att man ser att
% hnormen alltså diffens mängd nollor framför talet dubblerades för varje iterering.
% Kvadratisk
